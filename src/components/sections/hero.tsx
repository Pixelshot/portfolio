                ...
                <div className="space-y-6 order-2 md:order-1">
                    ...
                    <div className="pt-10 flex items-center gap-6">
                        <a href="/resume.pdf" target="_blank" rel="noopener noreferrer">
                            <Button size="lg" className="rounded-full text-lg px-8 py-6 bg-[#AAC4F5] hover:bg-[#7077A1] active:bg-[#7077A1] dark:bg-[#F6B17A] dark:hover:bg-[#F7A5A5] dark:active:bg-[#F7A5A5] hover:drop-shadow-xl text-white border-none transition-colors">
                                View Resume
                            </Button>
                        </a>
